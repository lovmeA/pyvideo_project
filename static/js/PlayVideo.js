...
VideoPlay.prototype.routeConfig = function (paths) {
    var me = this;
    var host1 = paths[paths.length - 1];
    paths[paths.length - 1] = me.fullWindow + host1.substring(1, host1.length);
...
VideoPlay.prototype.playVideo = function () {
    var me = this;
	if(host && host !== ''){
		var me_url = me.href.split('/static/');
		me.href = host+ "/static/" + me_url[1];
	}
    ...
    layer.msg(html, {
        ...
        success: function (layero, index) {
            me.titleIndex = index;
            $(document.getElementsByClassName('layui-layer-dialog')).append("<div class='full-restore-box'><a href='javascript:void(0)'>＋</a></div>");
